...
//node utilities/extract_graph.js contracts/contract.sol
...
fs.writeFileSync('../graphs/graph.json', JSON.stringify(out, null, 2));
...
//prompt://You are a blockchain security auditor. Summarize the following Solidity smart contract:
//[Paste the raw Solidity code here]

//prompt://You are a blockchain security auditor. Summarize the following Solidity smart contract. 
//Here is the control-flow graph in JSON format:
//[Paste graph.json here]
